defmodule ThunderlineWeb.Components.Tabs do
  @moduledoc """
  `ThunderlineWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import ThunderlineWeb.Components.Badge, only: [badge: 1]
