defmodule ThunderlineWeb.Components.Image do
  @moduledoc """
  The `ThunderlineWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
