defmodule ThunderlineWeb.Components.Indicator do
  @moduledoc """
  The `ThunderlineWeb.Components.Indicator` module provides a versatile component for visually highlighting
