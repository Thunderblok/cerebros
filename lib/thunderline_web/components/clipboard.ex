defmodule ThunderlineWeb.Components.Clipboard do
  @moduledoc """
  The `ThunderlineWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
