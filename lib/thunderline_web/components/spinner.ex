defmodule ThunderlineWeb.Components.Spinner do
  @moduledoc """
  The `ThunderlineWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `ThunderlineWeb.Components.Spinner` module enables developers to provide
