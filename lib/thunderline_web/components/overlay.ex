defmodule ThunderlineWeb.Components.Overlay do
  @moduledoc """
  The `ThunderlineWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `ThunderlineWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
