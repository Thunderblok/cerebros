defmodule ThunderlineWeb.Components.Chat do
  @moduledoc """
  `ThunderlineWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
