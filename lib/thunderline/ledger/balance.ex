defmodule Thunderline.Ledger.Balance do
  use Ash.Resource,
  ...
  balance do
    transfer_resource Thunderline.Ledger.Transfer
  ...
  relationships do
    belongs_to :transfer, Thunderline.Ledger.Transfer do
      attribute_type AshDoubleEntry.ULID
      allow_nil? false
      attribute_writable? true
    end

    belongs_to :account, Thunderline.Ledger.Account do
      allow_nil? false
      attribute_writable? true
    end
  end
