defmodule ThunderlineWeb.Components.RadioCard do
  @moduledoc """
  The `ThunderlineWeb.Components.RadioCard` module provides a customizable radio card component for Phoenix LiveView
