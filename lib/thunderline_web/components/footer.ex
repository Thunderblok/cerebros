defmodule ThunderlineWeb.Components.Footer do
  @moduledoc """
  The `ThunderlineWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
