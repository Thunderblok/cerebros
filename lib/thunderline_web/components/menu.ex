defmodule ThunderlineWeb.Components.Menu do
  @moduledoc """
  The `ThunderlineWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `ThunderlineWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import ThunderlineWeb.Components.Button, only: [button_link: 1]
