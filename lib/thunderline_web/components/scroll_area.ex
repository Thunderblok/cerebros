defmodule ThunderlineWeb.Components.ScrollArea do
  @moduledoc """
  The `ThunderlineWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
