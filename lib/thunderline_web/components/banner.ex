defmodule ThunderlineWeb.Components.Banner do
  @moduledoc """
  ThunderlineWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
