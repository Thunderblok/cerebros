defmodule ThunderlineWeb.Components.Popover do
  @moduledoc """
  The `ThunderlineWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
