defmodule ThunderlineWeb.Components.CheckboxCard do
  @moduledoc """
  The `ThunderlineWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
