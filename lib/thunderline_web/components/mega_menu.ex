defmodule ThunderlineWeb.Components.MegaMenu do
  @moduledoc """
  The `ThunderlineWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
