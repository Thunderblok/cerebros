defmodule ThunderlineWeb.Components.CheckboxField do
  @moduledoc """
  ThunderlineWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
